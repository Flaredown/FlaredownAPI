...
# INCOMPLETE ENTRY
Entry.create(user: u, catalogs: ["cdai"], responses: [{name: "weight_typical", value: 140}, {name: "ab_pain", value: 2}, {name: "general", value: 4}, {name: "complication_arthritis", value: 1}, {name: "complication_iritis", value: 0}, {name: "complication_erythema", value: 0}, {name: "complication_fistula", value: 0}, {name: "complication_fever", value: 1}, {name: "complication_other_fistula", value: 0}, {name: "opiates",  value: 0}, {name: "mass", value: 0}, {name: "hematocrit", value: 38}, {name: "weight_current", value: 140}], date: Date.today-13.day)
