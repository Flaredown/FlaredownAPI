# TODO CATALOG CURRENTLY DISABLED IN FAVOR OF RAPID3
module CdaiCatalog
#   extend ActiveSupport::Concern
#
#   QUESTIONS        = %i( complication_arthritis complication_iritis complication_erythema complication_fever complication_fistula complication_other_fistula opiates stools ab_pain general mass hematocrit weight_current weight_typical )
#   SCORE_COMPONENTS = %i( stools ab_pain general complications opiates mass hematocrit weight_deviation  )
#   COMPLICATIONS    = %i( complication_arthritis complication_erythema complication_fistula complication_other_fistula complication_iritis )
#   EXPECTED_USE     = [*1..8]
...
#
#   DEFINITION = {} # TODO get rid of CDAI or fill this out
#
#   included do |base_class|
#     validate :cdai_response_ranges
#     def cdai_response_ranges
#       ranges = [
#         ["stools", [*0..50]],
#         ["ab_pain", [*0..3]],
#         ["general", [*0..4]],
...
#     end
#
#     validate :cdai_response_booleans
#     def cdai_response_booleans
...
#       sum + (self.send("cdai_#{question_name}").zero? ? 20 : 0)
#     end
#   end
...
#     @past_entries.map {|e| e.cdai_stools}.reduce(:+) * 2
#   end
#
#   def cdai_ab_pain_score
#     @past_entries.map {|e| e.cdai_ab_pain}.reduce(:+) * 5
#   end
#
#   def cdai_general_score
#     @past_entries.map {|e| e.cdai_general}.reduce(:+) * 7
#   end
#
