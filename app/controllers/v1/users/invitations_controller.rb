class V1::Users::InvitationsController < Devise::InvitationsController
  ...
  def create
    opts[:from] = "no-reply@flaredown.com"
    opts[:reply_to] = "no-reply@flaredown.com"
    super
  end
  ...
  def edit
    ...
    # render :edit
    redirect_to "/#/accept-invitation/#{params[:invitation_token]}"
  end
